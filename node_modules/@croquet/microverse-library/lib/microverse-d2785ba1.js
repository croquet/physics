...
/* harmony export */   "THREE_MESH_BVH": () => (/* reexport module object */ three_mesh_bvh__WEBPACK_IMPORTED_MODULE_22__),
...
/* harmony import */ var three_mesh_bvh__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! three-mesh-bvh */ "./node_modules/three-mesh-bvh/src/index.js");
...
/* harmony import */ var three_examples_jsm_webxr_VRButton_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! three/examples/jsm/webxr/VRButton.js */ "./node_modules/three/examples/jsm/webxr/VRButton.js");
/* harmony import */ var three_examples_jsm_webxr_XRControllerModelFactory_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! three/examples/jsm//webxr/XRControllerModelFactory.js */ "./node_modules/three/examples/jsm/webxr/XRControllerModelFactory.js");
/* harmony import */ var _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @croquet/worldcore-kernel */ "./node_modules/@croquet/worldcore-kernel/index.js");
...
//-- ThreeVisible  -------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
const PM_ThreeVisible = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_20__.PM_Visible)(superclass) {
...
const PM_ThreeCamera = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_20__.PM_Camera)(superclass) {
    constructor(...args) {
        super(...args);
...
class XRController {
    constructor(manager) {
        ...
        this.controllerModelFactory = new three_examples_jsm_webxr_XRControllerModelFactory_js__WEBPACK_IMPORTED_MODULE_19__.XRControllerModelFactory();
...
class ThreeRenderManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_20__.RenderManager {
    ...
    setupRenderer(options) {
        ...
        this.hasXR().then((xr) => {
            if (xr) {
                this.vrButton = three_examples_jsm_webxr_VRButton_js__WEBPACK_IMPORTED_MODULE_18__.VRButton.createButton(this.renderer);
...
/* harmony import */ var _text_text_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./text/text.js */ "./src/text/text.js");
/* harmony import */ var _worldMenu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./worldMenu.js */ "./src/worldMenu.js");
/* harmony import */ var _settingsMenu_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./settingsMenu.js */ "./src/settingsMenu.js");
// Copyright 2022 by Croquet Corporation, Inc. All Rights Reserved.
// https://croquet.io
// info@croquet.io
...
class AvatarActor extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardActor).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.AM_Player) {
    ...
    ensureNicknameCard() {
        ...
        const measurement = _text_text_js__WEBPACK_IMPORTED_MODULE_5__.TextFieldActor.defaultMeasurement(nickname);
...
class AvatarPawn extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardPawn).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Player, PM_SmoothedDriver, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeCamera, _Pointer_js__WEBPACK_IMPORTED_MODULE_3__.PM_Pointer) {
    constructor(actor) {
        ...
        */
        ...
        (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_6__.filterDomEventsOn)(document.getElementById("homeBttn"));
        document.getElementById("usersComeHereBttn").onclick = () => this.comeToMe();
        (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_6__.filterDomEventsOn)(document.getElementById("usersComeHereBttn"));
        ...
        (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_6__.setupWorldMenuButton)(this, _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.App, this.sessionId);
    ...
    showSettingsMenu() {
        ...
        let promise = new Promise((resolve, _reject) => {
            (0,_settingsMenu_js__WEBPACK_IMPORTED_MODULE_7__.startSettingsMenu)(false, resolve);
        });
...
class CardPawn extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Pawn).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Smoothed, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _Pointer_js__WEBPACK_IMPORTED_MODULE_2__.PM_PointerTarget, _code_js__WEBPACK_IMPORTED_MODULE_6__.PM_Code) {
    ...
    construct3D(options) {
        ...
        if (options.placeholder) {
            ...
            const texture = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.TextureLoader().load(gridImage);
    ...
    */
    ...
    addWire(obj3d) {
        ...
        obj3d.traverse((obj)=>{
            if(obj.geometry){
                let edges = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.EdgesGeometry(obj.geometry);
                let line = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.LineSegments( edges, new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.LineBasicMaterial( { color: 0x44ff44} ));
                ...
                mat.forEach(m=>{
                    ...
                    if(c && !m._oldColor) { // check for reused color
                        ...
                        m.color = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Color(gray, gray, gray);
                    }
                })
                parts.push( obj );
            }
...
class ScriptingBehavior extends Model {
    ...
    setCode(string) {
        ...
        let cls;
        try {
            const Microverse = {..._croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__, ..._ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__, ..._physics_js__WEBPACK_IMPORTED_MODULE_2__, ..._frame_js__WEBPACK_IMPORTED_MODULE_3__};
...
/* harmony import */ var _frame_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./frame.js */ "./src/frame.js");
/* harmony import */ var _code_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./code.js */ "./src/code.js");
/* harmony import */ var _portal_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./portal.js */ "./src/portal.js");
/* harmony import */ var _worldSaver_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./worldSaver.js */ "./src/worldSaver.js");
/* harmony import */ var _settingsMenu_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./settingsMenu.js */ "./src/settingsMenu.js");
/* harmony import */ var _apps_multiblaster_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../apps/multiblaster.js */ "./apps/multiblaster.js");
...
function loadInitialBehaviors(paths, directory) {
    let library = _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.Library || new _code_js__WEBPACK_IMPORTED_MODULE_8__.CodeLibrary();
    ...
    return Promise.all(promises).then((array) => {
        array.forEach((pair) => {
            ...
            (0,_code_js__WEBPACK_IMPORTED_MODULE_8__.checkModule)(module); // may throw an error
...
class MyPlayerManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PlayerManager {
    ...
    createPlayer(playerOptions) {
        ...
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "MyPlayerManager", this.avatarCount);
    ...
    continuePresenting(presenter, presenterToken) {
        ...
        if (!this.presentationMode) {
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "continuePresenting", presenter.id, presenterToken);
            ...
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "continuePresenting rejected due to presentation in progress");
        }
    }
    ...
    continueFollowing(follower, presenterToken) {
        ...
        if (this.presentationMode && this.presenter.presenterToken === presenterToken) {
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "continueFollowing", this.presenter.id, presenterToken);
            this.followers.add(follower.playerId);
            follower.presentationStarted();
            this.publish("playerManager", "playerCountChanged");
        } else {
            follower.presenterToken = presenterToken;
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "continueFollowing: expected presenter not presenting", presenterToken);
        }
    }

    playerEnteredWorld(player) {
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "playerEnteredWorld", player);
        this.publish("playerManager", "playerCountChanged");
    }

    playerLeftWorld(player) {
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.frameName)(), "playerLeftWorld", player);
...
class MyModelRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ModelRoot {
    static modelServices() {
        return [
            ...
            _code_js__WEBPACK_IMPORTED_MODULE_8__.BehaviorModelManager,
            _text_text_js__WEBPACK_IMPORTED_MODULE_4__.FontModelManager,
            ...(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.UseRapier ? [{service: _physics_js__WEBPACK_IMPORTED_MODULE_2__.RapierPhysicsManager, options: {useCollisionEventQueue: true}}] : [])
        ];
    }
    init(options, persistentData) {
        ...
        appManager.add(_apps_multiblaster_js__WEBPACK_IMPORTED_MODULE_12__.MultiBlaster);
        appManager.add(_text_text_js__WEBPACK_IMPORTED_MODULE_4__.TextFieldActor);
        appManager.add(_portal_js__WEBPACK_IMPORTED_MODULE_9__.PortalActor);
    ...
    loadPersistentData({ _name, version, data }) {
        try {
            ...
            let saver = new _worldSaver_js__WEBPACK_IMPORTED_MODULE_10__.WorldSaver(_card_js__WEBPACK_IMPORTED_MODULE_5__.CardActor);
...
class MyViewRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ViewRoot {
    static viewServices() {
        const services = [
            ...
            _card_js__WEBPACK_IMPORTED_MODULE_5__.VideoManager,
            _code_js__WEBPACK_IMPORTED_MODULE_8__.BehaviorViewManager,
        ];
...
function startMicroverse() {
    ...
    (0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.sendToShell)("hud", {joystick: false, fullscreen: false});
    setButtons("none");
    ...
    const configPromise = new Promise(resolve => resolveConfiguration = resolve)
        .then(localConfig => {
            ...
            return !localConfig.showSettings || localConfig.userHasSet
                ...
                : new Promise(resolve => (0,_settingsMenu_js__WEBPACK_IMPORTED_MODULE_11__.startSettingsMenu)(true, resolve));
        });
    (0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.sendToShell)("send-configuration");

    return configPromise.then(changed => {
        if (changed) (0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.sendToShell)("update-configuration", { localConfig: window.settingsMenuConfiguration });
        (0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.sendToShell)("hud", {joystick: true, fullscreen: true});
        setButtons("flex");
        return getAntialias();
    }).then((aa) => {
        AA = aa;
...
async function launchMicroverse() {
    ...
    if (!basename.endsWith(".vrse")) {
        ...
        const json = new _worldSaver_js__WEBPACK_IMPORTED_MODULE_10__.WorldSaver().parse(text);
        _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.AvatarNames = defaultAvatarNames;
        _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.SystemBehaviorDirectory = defaultSystemBehaviorDirectory;
        _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.SystemBehaviorModules = defaultSystemBehaviorModules;
        if (json.data.useRapier) {
            _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.UseRapier = json.data.useRapier;
        }
        ...
        _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.Library = new _code_js__WEBPACK_IMPORTED_MODULE_8__.CodeLibrary();
...
(0,_frame_js__WEBPACK_IMPORTED_MODULE_7__.addShellListener)(shellListener);
...
class TextFieldPawn extends _card_js__WEBPACK_IMPORTED_MODULE_3__.CardPawn {
    ...
    setupScrollMesh() {
        let geom = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.PlaneGeometry(0.1, 5);
        let mat = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.MeshBasicMaterial({color: 0xFF0000, side: _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.DoubleSide});
        ...
        let knobGeom = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.PlaneGeometry(0.1, 0.1);
        let knobMat = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.MeshBasicMaterial({color: 0x00FF00, side: _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.DoubleSide});
    ...
    ensureSelection(id) {
        ...
        if (!sel) {
            const bar = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Mesh(new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.PlaneBufferGeometry(0.1, 0.1), new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.MeshBasicMaterial({color}));
